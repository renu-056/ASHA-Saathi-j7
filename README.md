...
## 🚀 Live Demo
**Web Application:** [https://asha-saathi-web-application.vercel.app](https://asha-saathi-web-application.vercel.app)
---
## Features
...
Create `.env.local`:
```env
NEXT_PUBLIC_SUPABASE_URL=[https://xmseivpecwoohteufpav.supabase.co](https://xmseivpecwoohteufpav.supabase.co)
